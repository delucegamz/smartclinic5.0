...
<div class="form-horizontal">
	...
	<h3 style="text-align:left">Data Cuti</h3>
	...
	<h4 style="text-align:left">Perlu mengambil cuti selama</h4>
	...
	<div class="form-group">
		<label class="control-label col-xs-4" for="pemeriksaan_fisik">Karena</label>
		<div class="col-xs-8">
		{{ $rf->jenis_cuti }}				
		</div>
	</div>
